...
--
-- Host: mysql-18b614b6-estudante-859d.b.aivencloud.com    Database: cinema
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '311ed727-43f5-11f1-b5dd-6e96f3234747:1-62,
5f84f037-3e7c-11f1-8d92-4e9cdacb05f9:1-83';
...
INSERT INTO `cliente` VALUES (1,'João Silva','123.456.789-00','joao@email.com','ATIVO'),(2,'Maria Oliveira','987.654.321-11','maria@email.com','ATIVO'),(3,'Carlos Souza','111.222.333-44','carlos@email.com','INATIVO');
...
INSERT INTO `filme` VALUES (1,'Interestelar 2',12,160,'EM CARTAZ',4),(2,'O Chamado da Noite',18,110,'EM CARTAZ',3),(3,'Aventuras no Gelo',0,95,'EM CARTAZ',5),(4,'Velozes e Furiosos 25',14,130,'FORA CARTAZ',1);
...
INSERT INTO `ingresso` VALUES (1,1,1,1,40.00,'PAGO'),(2,1,1,2,20.00,'PAGO'),(3,2,3,1,40.00,'RESERVADO');
...
INSERT INTO `pedido` VALUES (1,'2026-04-29 20:00:52',1,'PAGO'),(2,'2026-04-29 20:00:52',2,'ABERTO');
...
INSERT INTO `sala` VALUES (1,'Sala 01 - Principal','IMAX',150,1),(2,'Sala 02 - Standard','2D',100,0),(3,'Sala 03 - Experiência','3D',80,0);
...
INSERT INTO `sessao` VALUES (1,'2024-05-10 14:00:00','ABERTA',1,1),(2,'2024-05-10 17:30:00','ABERTA',1,1),(3,'2024-05-10 20:00:00','ABERTA',3,2),(4,'2024-05-11 13:00:00','ABERTA',2,3);
...
INSERT INTO `tipo_ingresso` VALUES (1,'Inteira',40.00),(2,'Meia-Entrada',20.00),(3,'Promocional Terça',15.00);
...
-- Dump completed on 2026-04-29 17:04:11
